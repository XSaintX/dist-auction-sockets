...
var ProductList = /** @class */ (function () {
    ...
    ProductList.prototype.ListItemsAuction = function () {
        var output = this.list_products.filter(function (x) { return x.bidding == true; });
        return [
            { data: output }
        ];
    };
    ProductList.prototype.finished = function () {
    ...
    ProductList.prototype.bidding = function () {
    ...
    ;
    ProductList.prototype.updatestate = function (sku, bidding) {
        for (var i in this.list_products) {
    ...
    ProductList.prototype.sold = function (user) {
        for (var i in this.list_products) {
